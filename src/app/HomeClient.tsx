    ...
    <>
      ...
      <section className="pt-32 pb-28 bg-gradient-to-b from-slate-50 via-gray-50 to-orange-50 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
          <DraggableScrollContainer className="flex gap-8 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-4 px-4 -mx-4 [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full max-w-[100vw]">
            {/* Instagram Reel */}
            <div className="shrink-0 snap-center flex flex-col items-center gap-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-gray-400 font-medium tracking-wide">Mr. Sachin Dube</span>
              </div>
            </div>
            ...
            <div className="shrink-0 snap-center flex flex-col items-center gap-3">
              <div className="relative rounded-2xl overflow-hidden shadow-xl shadow-red-200/40 border border-gray-200/60">
                <iframe
                  src="https://www.youtube.com/embed/PgJpqtJ9Swg"
                  className="w-[300px] h-[530px] sm:w-[340px] sm:h-[600px] border-0"
                  allowFullScreen
                  loading="lazy"
                  title="Driver testimonial - ATES on the road"
                />
              </div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-gray-400 font-medium tracking-wide">Autovellia</span>
              </div>
            </div>

            {/* Coming Soon Slot 2 */}
            <div className="w-[300px] h-[530px] sm:w-[340px] sm:h-[600px] rounded-2xl border-2 border-dashed border-gray-300 bg-white/60 flex flex-col items-center justify-center gap-4 snap-center shrink-0">
  ...
  const benefits = [
    {
      ...
      description: 'Our automatic tyre inflation system maintains optimal pressure at all times, eliminating the risk of underinflation-related blowouts that cause 95% of tyre failures on Indian highways.',
    },
    {
      icon: <TrendingUp className="w-8 h-8 text-primary-400" />,
      title: 'Extends Tyre Life by 20%',
      description: 'Consistent tyre pressure means even tread wear across all tyres. Fleet operators using our tyre maintenance system report 20% longer tyre life, saving lakhs annually on replacement costs.',
    },
    {
      icon: <Zap className="w-8 h-8 text-primary-400" />,
      title: 'Reduces Fuel Consumption',
      description: 'Underinflated tyres increase rolling resistance and fuel consumption. Our truck tyre pressure monitoring system ensures optimal inflation, delivering 2%+ fuel savings across your fleet.',
    },
    {
      icon: <AlertTriangle className="w-8 h-8 text-primary-400" />,
      title: 'Eliminates Manual Checks',
      description: 'No more daily tyre pressure inspections. ATES automatically monitors and corrects pressure for every tyre on your trucks and trailers, saving 144+ hours of maintenance downtime per vehicle each year.',
    },
  ];

  return (
    <section ref={ref} className="py-20 bg-gradient-to-b from-slate-900 to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">
            Why India&apos;s Fleet Owners Choose Wick ATES
          </h2>
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Wick&apos;s tyre maintenance system is designed specifically for Indian road conditions, helping fleet operators reduce costs, improve safety, and maximise tyre life.
          </p>
        </motion.div>
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 bg-primary-500/10 rounded-xl p-3">
                  {benefit.icon}
                </div>
                <div>
