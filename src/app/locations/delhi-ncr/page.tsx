  ...
  const challenges = [
    {
      ...
      description:
        'Delhi NCR sees 5C winters to 47C summers. This 42-degree swing causes massive tyre pressure fluctuations. Underinflated tyres in summer overheat; overinflated tyres in winter lose grip.',
    },
    {
      icon: TrafficCone,
      title: 'Severe Congestion',
      description:
        'NCR roads average 25-30 km/h during peak hours. Constant braking and acceleration in Gurgaon-Delhi and Noida-Delhi corridors cause uneven tyre wear that manual checks miss entirely.',
    },
    {
      icon: Building2,
      title: 'Construction Zone Damage',
      description:
        'Rapid metro expansion and expressway construction across Gurgaon, Noida, and Faridabad create debris-filled roads. Nails, gravel, and broken surfaces puncture and damage underinflated tyres faster.',
    },
    {
      icon: Truck,
      title: 'Multi-Modal Transport Demands',
      description:
        'NCR fleets switch between city delivery, highway hauling, and last-mile logistics. Different load patterns need different tyre pressures. Manual adjustment between routes is impractical.',
    },
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Automatic pressure equalization prevents the uneven wear caused by Delhi\'s extreme temperature swings and stop-start congestion patterns.',
    },
    {
      icon: Fuel,
      title: '2%+ Fuel Savings',
      description: 'Optimally inflated tyres reduce rolling resistance across NCR\'s mixed city-highway routes. Each truck saves thousands in diesel annually.',
    },
    {
      icon: Clock,
      title: 'Reduced Downtime',
      description: 'No more tyre-related breakdowns on NH-48, DND Flyway, or the Delhi-Mumbai Expressway. ATES maintains optimal pressure throughout the journey.',
    },
    {
      icon: Wrench,
      title: 'Lower Maintenance Costs',
      description: 'Eliminate daily manual pressure checks at NCR depots. Your maintenance team focuses on preventive work instead of routine tyre inspections.',
    },
  ];
    ...
    <main id="main-content" className="relative bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Breadcrumbs
            items={[
              ...
              { name: 'Delhi NCR', url: '/locations/delhi-ncr' },
            ]}
            className="mb-8"
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Wick HQ in Faridabad, NCR</span>
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
              Fleet tyre management solutions from Wick&rsquo;s home turf. Built for
              NCR&rsquo;s extreme temperatures, heavy congestion, and the demanding
              e-commerce logistics corridor.
            </p>
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Delhi NCR Fleet Challenges We Solve
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Operating a commercial fleet in NCR means battling extreme weather,
                relentless traffic, and constant road construction.
              </p>
            </motion.div>
      ...
      <section ref={benefitsRef} className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                How ATES Transforms NCR Fleet Operations
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                The Automatic Tyre Equalisation System by TyreRakhshak keeps your
                fleet running safely through NCR&rsquo;s toughest conditions.
              </p>
            </motion.div>
      ...
      <section ref={supportRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Local Support for Delhi NCR Fleets
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Wick is headquartered in Faridabad, right in the heart of NCR.
                That means faster service, shorter response times, and local expertise.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div variants={fadeInUp} className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  Faridabad Headquarters
                </h3>
                <p className="text-gray-600">
                  Our HQ is in NCR. Gurgaon, Noida, and Delhi fleets get
                  same-day support. On-site installation within 24 hours of order
                  confirmation.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="text-center">
                ...
                <p className="text-gray-600">
                  ...
                  pressure readings, and system diagnostics. Direct line to our
                  engineering team.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="text-center">
                ...
                <p className="text-gray-600">
                  Our technicians come to your NCR depot for installation.
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                ROI for Delhi NCR Fleet Operators
              </h2>
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                ATES pays for itself within months. Here is what NCR fleet
      ...
      <section ref={ctaRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Ready to Protect Your NCR Fleet?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
              Get a free fleet assessment and see how much ATES can save your
              Delhi NCR operations. We are just a short drive away in Faridabad.
            </p>
