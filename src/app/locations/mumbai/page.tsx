...
export default function MumbaiPage() {
  ...
  const challenges = [
    {
      icon: CloudRain,
      title: 'Heavy Monsoon Flooding',
      description:
        'Mumbai receives 2,400mm+ rainfall annually. Waterlogged roads accelerate tyre wear, damage valve stems, and cause pressure irregularities that lead to blowouts on key routes.',
    },
    {
      icon: Thermometer,
      title: 'Extreme Heat and Humidity',
      description:
        'Summer temperatures exceeding 40C combined with 80%+ humidity cause tyre pressure fluctuations. Underinflated tyres overheat, increasing the risk of tread separation on long highway runs.',
    },
    {
      icon: Truck,
      title: 'Long Highway Routes',
      description:
        'Mumbai-Pune Expressway (93km) and Mumbai-Ahmedabad highway (530km) demand consistent tyre pressure over varying elevations and road surfaces. Manual checks at pit stops waste time.',
    },
    {
      icon: Anchor,
      title: 'Port Logistics Congestion',
      description:
        'JNPA and Mumbai Port handle 60%+ of India\'s container traffic. Slow-moving port queues and heavy loads strain tyres. Stop-start driving at terminals accelerates uneven wear.',
    },
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Automatic pressure equalization prevents uneven wear patterns common on Mumbai\'s pothole-ridden roads and monsoon-damaged surfaces.',
    },
    {
      icon: Fuel,
      title: '2%+ Fuel Savings',
      description: 'Optimally inflated tyres reduce rolling resistance on long Mumbai-Pune and Mumbai-Ahmedabad hauls, saving thousands in fuel costs per vehicle annually.',
    },
    {
      icon: Clock,
      title: 'Reduced Downtime',
      description: 'No more roadside tyre checks or emergency replacements in the middle of NH-48. ATES keeps pressure optimal throughout the journey.',
    },
    {
      icon: Wrench,
      title: 'Lower Maintenance Costs',
      description: 'Eliminate manual pressure checks at depots. Fleet mechanics focus on preventive maintenance instead of daily tyre inspections.',
    },
  ];
    ...
    <main id="main-content" className="relative bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Serving Mumbai &amp; Maharashtra</span>
            </motion.div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
              Fleet safety solutions built for Mumbai&rsquo;s monsoon-soaked roads,
              scorching summers, and the demanding Mumbai-Pune-Ahmedabad highway corridor.
            </p>
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Mumbai Fleet Challenges We Solve
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Operating a commercial fleet in Mumbai comes with unique tyre management
                challenges that conventional maintenance cannot address.
              </p>
            </motion.div>
      ...
      <section ref={benefitsRef} className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                How ATES Transforms Mumbai Fleet Operations
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                The Automatic Tyre Equalisation System by TyreRakhshak keeps your
                fleet running safely through Mumbai&rsquo;s toughest conditions.
              </p>
            </motion.div>
      ...
      <section ref={supportRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Local Support for Mumbai Fleets
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div variants={fadeInUp} className="text-center">
                ...
                <p className="text-gray-600">
                  Our Faridabad headquarters supports Mumbai fleets with on-site
              ...
              <motion.div variants={fadeInUp} className="text-center">
                ...
                <p className="text-gray-600">
                  Our technicians come to your Mumbai depot for installation.
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                ROI for Mumbai Fleet Operators
              </h2>
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                ATES pays for itself within months. Here is what Mumbai fleet
      ...
      <section ref={ctaRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Ready to Protect Your Mumbai Fleet?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
              Get a free fleet assessment and see how much ATES can save your
              Mumbai operations. No obligation, no sales pressure.
            </p>
