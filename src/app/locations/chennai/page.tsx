...
export default function ChennaiPage() {
  ...
  const challenges = [
    {
      icon: Droplets,
      title: 'Coastal Humidity and Salt Air',
      description:
        'Chennai\'s coastal location means 70-85% humidity year-round. Salt-laden air corrodes valve stems and tyre components faster than inland cities. Moisture ingress causes slow pressure loss that is hard to detect manually.',
    },
    {
      icon: Anchor,
      title: 'Port Logistics Intensity',
      description:
        'Chennai Port is India\'s second-largest container port. Ennore and Kamarajar ports add more volume. Heavy container loads, slow-moving port queues, and frequent braking strain tyres beyond normal wear patterns.',
    },
    {
      icon: Factory,
      title: 'Auto Manufacturing Logistics',
      description:
        'Chennai is the Detroit of India. Hyundai, Renault-Nissan, Royal Enfield, and hundreds of auto ancillary units run high-frequency parts logistics. Tyre failures delay just-in-time supply chains.',
    },
    {
      icon: Truck,
      title: 'Long Haul to Bangalore and Beyond',
      description:
        'Chennai-Bangalore highway (540km) and Chennai-Hyderabad corridor are key freight routes. Varying road quality and elevation changes demand consistent tyre pressure across the entire journey.',
    },
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Automatic pressure equalization prevents the uneven wear caused by Chennai\'s coastal humidity and heavy port loads. Tyres last significantly longer even in harsh conditions.',
    },
    {
      icon: Fuel,
      title: '2%+ Fuel Savings',
      description: 'Optimally inflated tyres reduce rolling resistance on Chennai\'s key freight corridors. Auto logistics and textile distribution fleets see immediate diesel cost reductions.',
    },
    {
      icon: Clock,
      title: 'Reduced Downtime',
      description: 'No more tyre-related delays on the Chennai-Bangalore highway or port access roads. ATES keeps your fleet on schedule through monsoon and summer alike.',
    },
    {
      icon: Wrench,
      title: 'Lower Maintenance Costs',
      description: 'Eliminate daily manual pressure checks at Chennai depots. Your maintenance team focuses on preventive work instead of routine tyre inspections in the coastal heat.',
    },
  ];
    ...
    <main id="main-content" className="relative bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">Serving Chennai &amp; Tamil Nadu</span>
            </motion.div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Tyre Inflation System in{' '}
              <span className="text-red-400">Chennai</span>
            </h1>

            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
              Fleet tyre management solutions for Chennai&rsquo;s auto manufacturing
              logistics, port container transport, and textile distribution operators
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Chennai Fleet Challenges We Solve
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Operating a commercial fleet in Chennai means battling coastal
                corrosion, heavy port traffic, and the precision demands of auto
      ...
      <section ref={benefitsRef} className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                How ATES Transforms Chennai Fleet Operations
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                The Automatic Tyre Equalisation System by TyreRakhshak keeps your
                fleet running safely through Chennai&rsquo;s coastal conditions and
                demanding logistics environment.
              </p>
            </motion.div>
      ...
      <section ref={supportRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Local Support for Chennai Fleets
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div variants={fadeInUp} className="text-center">
                ...
                <p className="text-gray-600">
                  Our Faridabad headquarters supports Chennai fleets with on-site
                  installation and periodic maintenance visits across Tamil Nadu.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="text-center">
                ...
                <p className="text-gray-600">
                  Our technicians come to your Chennai depot for installation.
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                ROI for Chennai Fleet Operators
              </h2>
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                ATES pays for itself within months. Here is what Chennai fleet
      ...
      <section ref={ctaRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Ready to Protect Your Chennai Fleet?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
              Get a free fleet assessment and see how much ATES can save your
              Chennai operations. No obligation, no sales pressure.
            </p>
